-- Fix DELETE statement to include WHERE clause for RLS compatibility
...
BEGIN
  ...
  -- Clear current content (with WHERE clause for RLS)
  DELETE FROM public.landing_page_content WHERE id IS NOT NULL;
