-- Fix search path for the newly created functions
DROP FUNCTION IF EXISTS public.analyze_user_relations(uuid);
...
BEGIN
  ...
  FROM profiles WHERE user_id = _replacement_user_id;
