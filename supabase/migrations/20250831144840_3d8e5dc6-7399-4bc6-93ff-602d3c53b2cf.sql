-- Corrigir função create_startup_company com parâmetros default corretos
DROP FUNCTION IF EXISTS public.create_startup_company(text, text, text, text[], text, uuid);
...
BEGIN
  ...
  -- Criar a empresa startup com qualificação completa para evitar ambiguidade
