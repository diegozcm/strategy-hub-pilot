-- Drop and recreate the calculate_kr_metrics function with fixed logic
-- This fixes the issue where ytd_target and quarter targets were 0 when monthly_actual didn't exist
...
-- Recalculate all KRs with the new fixed logic
SELECT calculate_kr_metrics(id) FROM key_results;