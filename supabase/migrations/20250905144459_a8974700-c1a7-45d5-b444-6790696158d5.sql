-- Fix the duplicate profile creation issue
-- The problem is that both create_user_by_admin and handle_new_user trigger
-- are trying to create profiles, causing a unique constraint violation

-- Update the create_user_by_admin function to handle the conflict
