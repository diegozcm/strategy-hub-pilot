...
const TermsOfUsePage = () => (
  <div className="min-h-screen bg-[#071520] text-white">
    <div className="container mx-auto px-4 py-16 max-w-3xl">
      ...
      <h1 className="text-3xl lg:text-4xl font-display font-bold mb-8">Termos de Uso</h1>
      <div className="prose prose-invert prose-sm max-w-none font-sans text-white/60 space-y-6">
        <p>Última atualização: {new Date().toLocaleDateString('pt-BR')}</p>
        <section>
          <h2 className="text-lg font-display font-semibold text-white/80">1. Aceitação dos Termos</h2>
          <p>Conteúdo dos termos de uso será adicionado em breve.</p>
        </section>
        <section>
          <h2 className="text-lg font-display font-semibold text-white/80">2. Uso da Plataforma</h2>
          <p>Conteúdo será adicionado em breve.</p>
        </section>
        <section>
          <h2 className="text-lg font-display font-semibold text-white/80">3. Responsabilidades</h2>
          <p>Conteúdo será adicionado em breve.</p>
        </section>
        <section>
          <h2 className="text-lg font-display font-semibold text-white/80">4. Propriedade Intelectual</h2>
          <p>Conteúdo será adicionado em breve.</p>
        </section>
        <section>
