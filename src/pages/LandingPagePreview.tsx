...
const LandingPagePreview = () => {
  ...
  return (
    <div className="min-h-screen bg-cofound-white">
      ...
      <section className="pt-32 pb-20 px-4 bg-cofound-navy relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold text-cofound-white mb-6 leading-tight">
            ...
            <Button 
              size="lg" 
              className="text-lg px-8 py-6 bg-cofound-cyan hover:bg-cofound-cyan/90 text-cofound-white border-none"
      ...
      {trustLogos.length > 0 && (
        <section className="py-16 px-4">
          <div className="container mx-auto">
            <Card className="bg-cofound-cyan rounded-3xl p-12 border-none shadow-xl">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center">
                {trustLogos.map((logo, idx) => (
                  <div key={idx} className="flex items-center justify-center bg-cofound-white rounded-lg p-4 h-20">
      ...
      {/* Services Section */}
      <section className="py-20 px-4 bg-cofound-light-gray">
        <div className="container mx-auto">
      ...
      {/* Education Section */}
      <section className="py-20 px-4 bg-cofound-navy">
        <div className="container mx-auto">
      ...
      {/* Cofounders Section */}
      <section className="py-20 px-4 bg-cofound-cyan">
        <div className="container mx-auto">
          <div className="text-center mb-16">
      ...
      <section className="py-20 px-4 bg-cofound-navy">
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <Button 
              size="lg" 
              className="text-lg px-12 py-6 bg-cofound-cyan hover:bg-cofound-cyan/90 text-cofound-white border-none"
            ...
            <div className="flex items-center space-x-6">
              {getContent('footer', 'linkedin') && (
                <a 
                  ...
                  className="text-cofound-white hover:text-cofound-cyan transition-colors"
                >
