...
import { ArrowRight, Phone, Layers, Building2, Clock, ThumbsUp, FolderKanban } from 'lucide-react';
...
export const HeroSection: React.FC<Props> = ({ getContent }) => (
  <section className="pt-36 pb-20 lg:pt-40 lg:pb-28 px-4 relative overflow-hidden bg-cofound-blue-dark">
    {/* Background effects */}
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <Badge className="mb-8 bg-cofound-green/10 text-cofound-green border-cofound-green/25 px-4 py-2 font-sans text-xs tracking-wide rounded-full">
        ...
        {/* Right – screenshot */}
        <motion.div
          initial={{ opacity: 0, x: 40, scale: 0.95 }} animate={{ opacity: 1, x: 0, scale: 1 }} transition={{ duration: 0.7, delay: 0.3 }}
