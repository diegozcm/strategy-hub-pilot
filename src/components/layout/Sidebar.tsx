            ...
            >
              ...
              <div className="relative flex items-center gap-3 rounded-[10px] atlas-hub-btn-inner px-4 py-3.5 transition-all duration-300 overflow-hidden">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <span className="text-[9px] font-medium tracking-[0.15em] text-[hsl(var(--cofound-green))] group-hover:text-[hsl(var(--cofound-green))] transition-colors uppercase leading-tight mt-0.5">BY COFOUND</span>
                </div>
              </div>
            </NavLink>
          </div>
