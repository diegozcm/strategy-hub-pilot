...
import { PasswordManagementForm } from './users/PasswordManagementForm';
            ...
            <ScrollArea className="flex-1">
              ...
              {activeTab === 'actions' && (
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">Gerenciar Senha</CardTitle>
                      <CardDescription>
                        Resetar ou definir uma nova senha para o usuário
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      {/* Estado local para controle do formulário de senha */}
