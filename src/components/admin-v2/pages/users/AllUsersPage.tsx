...
import { Users, UserCheck, UserX, Shield, Search, Plus, MoreHorizontal, Eye } from 'lucide-react';
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <Button variant="cofound" onClick={() => navigate('/app/admin/users/create')}><Plus className="h-4 w-4 mr-2" />Criar Usuário</Button>
          </div>
        </CardHeader>
        <CardContent>
