...
import { Users, CheckCircle, Search, Building2 } from "lucide-react";
...
export default function ActiveCompaniesPage() {
  ...
  return (
    <AdminPageContainer 
      ...
      description="Empresas com status ativo no sistema"
    >
          ...
          <CardHeader>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <CardTitle className="flex items-center gap-2">
                ...
                Empresas Ativas ({filteredCompanies.length})
              </CardTitle>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium">Nenhuma empresa ativa encontrada</h3>
                <p className="text-sm text-muted-foreground mt-1">
                  {searchQuery ? "Tente uma busca diferente" : "Não há empresas ativas no momento"}
                </p>
              </div>
            ) : (
              <Table>
