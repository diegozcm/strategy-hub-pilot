      ...
      <DialogContent className="sm:max-w-[1100px] max-h-[95vh] overflow-y-auto">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-[150px_180px_240px_140px_70px] gap-4 p-3 bg-muted/30 rounded-lg font-medium text-sm">
              <div>Mês</div>
            ...
            {months.map((month) => {
              ...
              return (
                <div key={month.key} className="grid grid-cols-[150px_180px_240px_140px_70px] gap-4 items-center p-3 border rounded-lg">
